...
import static com.example.pdfnotemate.tools.pdf.viewer.util.Constants.Cache.CACHE_SIZE;
import static com.example.pdfnotemate.tools.pdf.viewer.util.Constants.Cache.THUMBNAILS_CACHE_SIZE;
